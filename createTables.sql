...
DECLARE
	location_id VARCHAR2(100);
	event_or_user VARCHAR2(100);
BEGIN
	event_or_user := :NEW.USER_ID;
	IF event_or_user IS NOT NULL THEN
		SELECT HOMETOWN_LOCATION_ID INTO location_id FROM UserLivesInLocation WHERE USER_ID = :NEW.USER_ID;
