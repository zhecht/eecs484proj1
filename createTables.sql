...
FOREIGN KEY (TAG_SUBJECT_ID) REFERENCES User(USER_ID)
);
...
FOREIGN KEY (RECEIVER_ID, SENDER_ID) REFERENCES User(USER_ID)
);

CREATE TABLE PhotoHasTag
(
TAG_ID VARCHAR2(100) UNIQUE,
PHOTO_ID VARCHAR2(100) UNIQUE,
...
FOREIGN KEY (USER1_ID, USER2_ID) REFERENCES User(USER_ID)
);
...
FOREIGN KEY (USER_ID) REFERENCES User(USER_ID),
FOREIGN KEY (CURRENT_LOCATION_ID, HOMETOWN_LOCATION_ID) REFERENCES Location(LOCATION_ID)
);
...
AFTER INSERT
	...
	FOR EACH ROW
BEGIN
	INSERT INTO UserSendsReceivesMessage (USER_ID, MESSAGE_ID) VALUES (:NEW.USER_ID, :NEW.MESSAGE_ID);
END;
...
AFTER INSERT
	...
	FOR EACH ROW
BEGIN
	INSERT INTO UserPlansEvent (EVENT_ID, USER_ID) VALUES (:NEW.EVENT_ID, :NEW.USER_ID);
END;
...
AFTER INSERT
	...
	FOR EACH ROW
BEGIN
	"""INSERT INTO Location (STATE) VALUES (:NEW.)"""
END;
