...
INSERT INTO Location (CITY, STATE, COUNTRY, USER_ID, EVENT_ID, CHECK_USER, CHECK_HOME) SELECT DISTINCT HOMETOWN_CITY, HOMETOWN_STATE, HOMETOWN_COUNTRY, USER_ID, NULL, FIRST_NAME, FIRST_NAME FROM keykholt.PUBLIC_USER_INFORMATION UNION SELECT DISTINCT CURRENT_CITY, CURRENT_STATE, CURRENT_COUNTRY, USER_ID, NULL, FIRST_NAME, NULL FROM keykholt.PUBLIC_USER_INFORMATION

INSERT INTO Location ((CITY, STATE, COUNTRY, EVENT_ID, CHECK_USER, CHECK_HOME) SELECT DISTINCT EVENT_CITY, EVENT_STATE, EVENT_COUNTRY, EVENT_ID, NULL, NULL FROM keykholt.PUBLIC_EVENT_INFORMATION;
