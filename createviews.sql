...
LEFT JOIN Location LH ON LH.LOCATION_ID = (SELECT LOCATION_ID FROM UserLivesInLocation WHERE USER_ID = U.USER_ID AND TYPE = 'HOMETOWN')
LEFT JOIN Location LC ON LC.LOCATION_ID = (SELECT LOCATION_ID FROM UserLivesInLocation WHERE USER_ID = U.USER_ID AND TYPE = 'CURRENT')
;
