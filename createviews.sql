...
JOIN Location LH ON U.USER_ID = (SELECT HOMETOWN_LOCATION_ID FROM UserLivesInLocation WHERE USER_ID = U.USER_ID)
JOIN Location LC ON U.USER_ID = (SELECT CURRENT_LOCATION_ID FROM UserLivesInLocation WHERE USER_ID = U.USER_ID)
;
